...
async function listExistingIds(boardDir) {
    const ids = new Set();
...
export async function generateCardId(boardDir) {
    ...
    throw new CardIdGenerationError(`Failed to generate unique card ID after ${MAX_RETRIES} attempts`);
}
